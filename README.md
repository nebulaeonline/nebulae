...
Well, the project files make it easy for someone to grab VS Community, clone the Github repo, and get started!  The project files can be used with MSVC, Clang with lld-link, or Clang with MSVC link.  The project itself is self-contained, including debugger (qemu).
